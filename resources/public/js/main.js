window.CLOSURE_UNCOMPILED_DEFINES = {"figwheel.repl.connect_url":"ws:\/\/localhost:9002\/figwheel-connect?fwprocess=58758c&fwbuild=dev"};
...
document.write('<script>goog.require("mario.main");</script>');
